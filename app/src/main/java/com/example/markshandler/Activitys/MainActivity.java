...
public class MainActivity extends AppCompatActivity {
    ...
    public void Fifth(){
        String [] subject = {"منظمة الحاسب الآلي" , "الحاسب الآلي و أمن البيانات" , "علم النفس الإجتماعي" , "الأصول الإجتماعية للتربية" ,
                "طرق تدريس(1)" , "إستخدام الجداول الإلكترونية" , "الإحصاء و الحاسب"};
    ...
    public void Sixth(){
        String [] subject = {"الذكاء الإصطناعي" , "الوسائط المتعددة" , "البرمجة الجاهزة(1)" , "تاريخ التربية والتعليم" , "علاقات أسرية" , "علم نفس تعليمي" ,
    ...
    public void Seventh(){
        String [] subject = {"النظم الخبيرة" , "البرمجة الجاهزه(2)" , "تطبيقات الحاسب الألي(2)" , "الشبكات العالمية" , "تربية مقارنة" , "طرق تدريس(2)" ,
                "علم النفس التعليمي"};
    ...
    public void Eighth(){
        String [] subject = {"طرق تخطيط البرامج" , "شبكات الحاسب الآلي" , "النظم المعاونة في إتخاذ القرار" , "البرمجة الشيئية والهيكلية" , "الأصول الفلسفية للتربية"
                , "المناهج" , "صحة نفسية وإرشاد"};
